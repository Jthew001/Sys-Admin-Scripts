...
Set-ItemProperty -Path $registryPath -Name "MDMWinsOverGP" -Value 1 -Type DWORD | Out-Null
Set-ItemProperty -Path $registryPath -Name "MDMWinsOverGP_ProviderSet" -Value 1 -Type DWORD | Out-Null
